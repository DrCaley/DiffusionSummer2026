"""
DDPM diffusion utilities for the red-noise experiment.

Noise schedule : linear (beta_1=1e-4 → beta_T=0.02)
Noise type     : red (Brownian) — 1/f² spectrum (S(f) ∝ 1/f²).
                 Strongly correlated, smooth noise; emphasises low-frequency /
...
# ---------------------------------------------------------------------------
# DDPM — linear schedule + red noise
# ---------------------------------------------------------------------------

class DDPM:
    """
    DDPM with a linear beta schedule and red (Brownian, 1/f²) noise.
