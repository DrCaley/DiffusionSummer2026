"""
batch_white_vs_annealed.py  –  White vs Annealed RePaint comparison.

Runs RePaint for white_noise and annealed_noise models across N seeds and
saves a 1×3 composite PNG (GT | White | Annealed) plus a summary.txt.

Usage:
    python "Colored Noise Test/batch_white_vs_annealed.py" \\
        --pickle  /root/model_pink_noise/data.pickle \\
        --ckpt    best          # or epoch100 / best_by_100
        --out_dir "Colored Noise Test/outputs/white_vs_annealed_r1"
"""
...
def main():
    ...
    out_dir = args.out_dir or os.path.join(_HERE, "outputs", "white_vs_annealed_r1")
    ...
    for i in range(args.n_samples):
        ...
        fig.suptitle(
            f"White vs Annealed — sample {i}, seed {sample_seed}\n"
    ...
    # ── Summary ───────────────────────────────────────────────────────────────
    lines = [
        f"White vs Annealed RePaint comparison",
