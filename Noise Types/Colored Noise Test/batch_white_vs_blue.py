"""
batch_white_vs_blue.py  –  White vs Blue RePaint comparison (r=1).

Runs RePaint for white_noise and blue_noise models across N seeds and
saves a 1×3 composite PNG (GT | White | Blue) plus a summary.txt.

Usage:
    python "Colored Noise Test/batch_white_vs_blue.py" \\
        --pickle /root/model_pink_noise/data.pickle \\
        --out_dir "Colored Noise Test/outputs/white_vs_blue_r1"
"""
...
def main():
    ...
    out_dir = args.out_dir or os.path.join(_HERE, "outputs", "white_vs_blue_r1")
    ...
    for i in range(args.n_samples):
        ...
        # ── Figure: 1 row × 3 cols (GT | White | Blue) ───────────────────────
        fig, axes = plt.subplots(1, 3, figsize=(21, 7))
        fig.suptitle(
            f"White vs Blue — sample {i}, seed {sample_seed}\n"
    ...
    # ── Summary ───────────────────────────────────────────────────────────────
    lines = [
        f"White vs Blue RePaint comparison",
