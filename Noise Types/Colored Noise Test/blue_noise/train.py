"""
Train the blue-noise DDPM model.

Noise schedule : linear (beta_1=1e-4 → beta_T=0.02, hardcoded)
Noise type     : blue — S(f) ∝ f² (high-frequency emphasis)
...
Usage (run from workspace root, with data.pickle present):
    python "Colored Noise Test/blue_noise/train.py" --resume "Colored Noise Test/blue_noise/checkpoints/best_model.pt"
    python "Colored Noise Test/blue_noise/train.py" --resume ... --patience 50 --epochs 500
"""
