"""
DDPM diffusion utilities for the pink-noise experiment.

Noise schedule : linear (beta_1=1e-4 → beta_T=0.02)
Noise type     : pink — 1/f spectrum (S(f) ∝ 1/f).
                 Long-range spatial correlations; emphasises medium-to-large
                 scales while retaining multi-scale structure.
...
# ---------------------------------------------------------------------------
# DDPM — linear schedule + pink noise
# ---------------------------------------------------------------------------

class DDPM:
    """
    DDPM with a linear beta schedule and pink (1/f) noise.
